...
fun NotificationScreen(navigateBack: () -> Unit) {
    Column(verticalArrangement = Arrangement.Top, horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier
        ...
        Icon(painterResource(id = R.drawable.notification), contentDescription = null, modifier = Modifier.size(120.dp).padding(top = 50.dp), tint = Color.LightGray)
        Text("You have no notifications yet", modifier = Modifier.padding(top = 20.dp))
    }
}